...
const query = {
  searchText: "The Godfather",
  searchCategory: "title",
};

let category = JSON.stringify(query.searchCategory)//?
let text = JSON.stringify(query.searchText)

console.log(movies[0][`${query.searchCategory}`])
